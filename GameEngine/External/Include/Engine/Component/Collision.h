...
class CCollision
{
	// Box To Box
public:
	static bool CollisionBox2DToBox2D(std::vector<FVector3>& _HitPoint, CColliderBox2D* _Src, CColliderBox2D* _Dest);
private:
	static bool CollisionAABB2DToAABB2D(std::vector<FVector3>& _HitPoint, const FBox2DInfo& _Src, const FBox2DInfo& _Dest);
	static bool CollisionOBB2DToOBB2D(std::vector<FVector3>& _HitPoint, const FBox2DInfo& _Src, const FBox2DInfo& _Dest);
	...
	// Sphere To Sphere
public:
	static bool CollisionSphere2DToSphere2D(std::vector<FVector3>& _HitPoint, CColliderSphere2D* _Src, CColliderSphere2D* _Dest);
private:
	static bool CollisionSphere2DToSphere2D(std::vector<FVector3>& _HitPoint, const FSphere2DInfo& _Src, const FSphere2DInfo& _Dest);
	
	// Box To Sphere
public:
	static bool CollisionBox2DToSphere2D(std::vector<FVector3>& _HitPoint, CColliderBox2D* _Box, CColliderSphere2D* _Sphere);
private:
	static bool CollisionBox2DToSphere2D(std::vector<FVector3>& _HitPoint, const FBox2DInfo& _Box, const FSphere2DInfo& _Sphere);

	// Line To Line
public: 
	static bool CollisionLine2DToLine2D(std::vector<FVector3>& _HitPoint, CColliderLine2D* _Src, CColliderLine2D* _Dest);
	static ECCWResult::Type CCW2D(const FVector3& _p1, const FVector3& _p2, const FVector3& _p3, float _EBound = 0.0000001);
...
private:
	static bool CollisionBox2DToLine2D(std::vector<FVector3>& _HitPoint, const FBox2DInfo& _Box, const FLine2DInfo& _Line);
	static bool CollisionBox2DToPoint(std::vector<FVector3>& _HitPoint, const FBox2DInfo& _Box, const FVector3& _Point);

	// Sphere To Line
public:
	static bool CollisionSphere2DToLine2D(std::vector<FVector3>& _HitPoint, CColliderSphere2D* _Sphere, CColliderLine2D* _Line);
private:
