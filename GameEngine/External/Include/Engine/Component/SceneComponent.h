...
public:
	void SetSimulatePhysics(bool _SimulatePhysics) { m_SimulatePhysics = _SimulatePhysics; }
	void SetUseGravity(bool _UseGravity) { m_UseGravity = _UseGravity; }
	void AddForce(const FVector3& _Force) { m_Accel += _Force * (1.f / max(m_Mass, 0.0001f)); }
	void SetPhysicsVelocity(const FVector3& _PhysicsVelocity) { m_PhysicsVelocity = _PhysicsVelocity; }
	const FVector3& GetPhysicsVelocity() { return m_PhysicsVelocity; }
